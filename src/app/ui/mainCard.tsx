...
export default async function MainCard ({ currentDay }: { currentDay:  currentDayInfo}) {
    ...
    return (
        <div className="flex flex-col rounded-l-2xl justify-start items-center w-full bg-white">
            ...
            <div className="mb-5">
                <h5 className="text-2xl text-center font-semibold tracking-tight text-black ">{currentDay.temperature} °C</h5>
                ...
                <div className="flex flex-row justify-start items-center mx-auto mb-5">
                    <CloudIcon className="h-10 w-10 text-black mr-5" />
                    <span className="text-black text-center text-l font-medium">{currentDay.weatherCode}</span>      
                </div>
                <div className="flex flex-row justify-start items-center mx-auto mb-10">
